...
const DOCS: Doc[] = [
  ...
  {
    name: '/config',
    usage: '/config canal · clips · canal-avisos · formato · contador · avisos · resumo · retrospectiva · momentos · cargos · status',
    category: 'servidor',
    summary: 'A configuração do servidor (só admin)',
    detail: [
      'Todo aviso nasce **desligado**. O Valdez só fala sozinho depois que alguém ligar o que quer ouvir.',
      ...
      '**canal-avisos** — onde caem avisos, resumo de call e retrospectiva. Sem canal aqui eu uso o de clips; sem nenhum dos dois, fico calado.',
      `**formato** — escolhe o que vem anexado no \`/clip\` e no \`/replay\`. O padrão é MP3, que sai na hora. No ${cheapestWith('roomVideo')} dá pra deixar o **vídeo da sala** como padrão, e aí o MP3 vira o botão.`,
      '**contador** — liga o contador de horas ao vivo no nome da call, atualizado a cada minuto.',
      '**avisos** — posta quem abriu a call, quem entrou e quanto tempo cada um ficou.',
      '**resumo** — quando a call acaba, posta um card com quem estava, o tempo de cada um e os prêmios da noite.',
      '**retrospectiva** — toda segunda ao meio-dia, o resumo da semana: horas, pódio e clips.',
